    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='form_app.department')),
            ],
        ),
        migrations.CreateModel(
            name='Teacher',
            fields=[
                ...
                ('t_department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='form_app.department')),
            ],
        ),
    ]
